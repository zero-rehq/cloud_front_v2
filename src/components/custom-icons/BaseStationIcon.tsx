export const BaseStationIcon = (props: IconProps) => {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' {...props} viewBox='0 0 24 24'>
			<g fill='none'>
				...
				></path>
				<path fill='currentColor' d='M7 16a1 1 0 1 1-2 0a1 1 0 0 1 2 0m3 0a1 1 0 1 1-2 0a1 1 0 0 1 2 0'></path>
				<path
					stroke='currentColor'
					strokeWidth={1.5}
				...
				></path>
				<path stroke='currentColor' strokeLinecap='round' strokeWidth={1.5} d='M16.5 12V9'></path>
			</g>
		</svg>
	);
};
